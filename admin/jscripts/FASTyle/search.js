...
(function(mod) {
  ...
  var queryDialog =
    '<input type="text" style="width: 10em" class="CodeMirror-search-field" placeholder="Search" /> <span class="prev icon-left-open-big button"></span><span class="next icon-right-open-big button"></span>';
